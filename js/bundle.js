...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({slide, container, prevArraw, nextArraw, currentCounter, totalCurrent, wrapper, field}) {
    
    const slides = document.querySelectorAll(slide),
        slider = document.querySelector(container),
        prev = document.querySelector(prevArraw),
        next = document.querySelector(nextArraw),
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    ;(0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('2024-06-01')
